                ...
                {isCalendarOpen && (
                  ...
                  >
                    <div className="flex items-center justify-between px-5">
                      <button
                        id="prevMonth"
                        className="rounded-md px-2 py-2 text-dark hover:bg-green-500 hover:text-white dark:text-white dark:hover:bg-dark"
                    ...
                    <div className="mt-5 flex justify-end space-x-2.5 border-t border-stroke p-5 dark:border-dark-3">
                      <button
                        id="cancelBtn"
                        className="rounded-lg px-5 py-2.5 text-black font-medium hover:bg-green-500 hover:text-white hover:scale-105 transition-transform"
